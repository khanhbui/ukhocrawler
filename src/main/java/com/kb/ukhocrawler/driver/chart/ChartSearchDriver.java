...
public class ChartSearchDriver extends SearchDriver {

    public ChartSearchDriver(Map<String, String> cookies, ChartInputDto input, int searchMethod) {
    ...
    protected void download() throws IOException {
        ChartInputDto chartInput = (ChartInputDto)this.input;
    ...
    protected void onError() {
        ...
        Util.error("Error: %s&%s=%s&%s=%s&%s=%s", Constant.SEARCH_URL, Constant.CHART_PREFIX, chartInput.getChartPrefix(), Constant.CHART_NUMBER, chartInput.getChartNumber(), Constant.CHART_SUFFIX, chartInput.getChartSuffix());
    }
}
