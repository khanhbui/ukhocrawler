...
public class ChartPreviewService extends RunnableService {

    protected ChartDto chart;
    protected String output;

    public ChartPreviewService(ChartDto chart, String output) {
        this.chart = chart;
        this.output = output;
    }
    ...
    protected void onError() {
        Util.error("ChartPreviewService::onError: %s", String.format(Constant.PREVIEW_URL, chart.getPreviewChartId()));
    }
